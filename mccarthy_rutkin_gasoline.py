...
carbon_dioxide_pounds = gas_gallons*19.64#output the pounds of carbon dioxide produced
#19 gallons of gasoline produced from aproximately 1 barrel of crude oil
crude_oil_barrels = gas_gallons / 19#use conversion factor to output crude oil barrels
#$2.60 current average for 1 gallon of gasoline
avgcost = gas_gallons * 2.60#multiply gas gallons by current average to output average cost

print gas_gallons,'gallons of gasoline produces approximately',carbon_dioxide_pounds,'pounds of carbon dioxide.'
print crude_oil_barrels,'barrels of crude oil produced from',gas_gallons,'gallons of gas.'
